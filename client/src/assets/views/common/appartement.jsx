...
function appartement() {
  return (
    <section className="property_section layout_padding pr_mobile_20">
      <div className="section_bg section_bg_left"></div>
        ...
        <div className="row background">
          <div className="col-lg-10 mx-auto">
              ...
              <div className="col-md-4 col-sm-6">
                <div className="box">
                  ...
                  <div className="detail-box">
                    ...
                    <a href="https://html.design/demo/evernest/property_detail.html">
                      <span>
                        Detail
                      </span>
                    </a>
            ...
            <div className="btn-box">
              <a href="https://html.design/demo/evernest/property.html">
                <span>
                  See More
                </span>
              </a>
